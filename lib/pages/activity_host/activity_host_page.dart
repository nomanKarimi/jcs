...
class ActivityHostPage extends StatelessWidget {
  const ActivityHostPage({Key? key}) : super(key: key);
            ...
            children:  [
              ...
              CustomButton(btnText: 'Sign up',padding: 20, onPress: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (_)=>SignUpAsHostPage()));
              },),
              SizedBox(height: 20,),
              ...
              CustomButton(btnText: 'Log in',padding: 20, onPress: () {
                Navigator.push(context,
                    MaterialPageRoute(builder: (_)=>LoginAsHostPage()));
              },)
