...
import 'package:jcs/pages/activity_host/host_pass_changed_success_page.dart';
...
class HostChangePasswordPage extends StatefulWidget {
  const HostChangePasswordPage({Key? key}) : super(key: key);

  @override
  State<HostChangePasswordPage> createState() => _HostChangePasswordPageState();
}

class _HostChangePasswordPageState extends State<HostChangePasswordPage> {
                        ...
                        CustomButton(btnText: 'SAVE', onPress: () {
                          if(formKey.currentState!.validate()){
                            ...
                            Navigator.push(context,
                                MaterialPageRoute(builder: (_)=>HostPassChangedSuccessPage()));
