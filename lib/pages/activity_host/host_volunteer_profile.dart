...
class HostVolunteerProfile extends StatelessWidget {
  const HostVolunteerProfile({Key? key}) : super(key: key);
      ...
      children: [
        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              Image.asset(volunteer.imgPath!,height: 100,width: 100,),
              sizedBox30,
              Row(
                mainAxisAlignment: MainAxisAlignment.center,

                children: [
                  Text(volunteer.name!,style: textMediumStyle.copyWith(color: PRIMARY_COLOR,fontSize: 22),),
                  SizedBox(width: 10,),
                  Text(volunteer.lName!,style: textMediumStyle.copyWith(color: PRIMARY_COLOR,fontSize: 22),),
                ],
              ),
              sizedBox30,
