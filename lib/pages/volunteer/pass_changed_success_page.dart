...
class PassChangedSuccessPage extends StatefulWidget {
  const PassChangedSuccessPage({Key? key}) : super(key: key);

  @override
  State<PassChangedSuccessPage> createState() => _PassChangedSuccessPageState();
}

class _PassChangedSuccessPageState extends State<PassChangedSuccessPage> {
                    ...
                    child: Column(
                      children:  [
                        ...
                        CustomButton(btnText: 'LOGIN', onPress: () {
                            Navigator.pushAndRemoveUntil(context, MaterialPageRoute(builder: (_)=>LoginAsVolunteerPage()), (route) => false);
